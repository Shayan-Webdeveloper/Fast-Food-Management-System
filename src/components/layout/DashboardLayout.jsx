...
const staffNav = [
  ...
  const { notifications, cart, markNotificationRead, markAllNotificationsRead } = useData() 
        ...
        <div className="flex flex-1 flex-col min-w-0">
          <header className={`sticky top-0 z-30 flex h-16 items-center gap-4 border-b px-4 backdrop-blur-xl lg:px-6 ${isDark ? 'border-slate-700 bg-slate-900/70' : 'border-slate-200 bg-white/80'}`}>
            ...
            <NavLink
              ...
              className={`relative hover:text-brand-500 ${isDark ? 'text-slate-300 hover:text-brand-400' : 'text-slate-600'}`}
            >
